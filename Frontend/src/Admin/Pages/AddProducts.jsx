...
const AddProducts = () => {
        ...
        const fetchEssentialData = async () => {
            try {
                if (isEdit) {
                    ...
                    setFormData((prev) => ({
                        ...prev,
                        category: Array.isArray(catRes.data) && catRes.data[0]?.name ? catRes.data[0].name : "",
    ...
    const derivedSubcategories = (() => {
        ...
        return selectedCat && selectedCat.subcategory ? selectedCat.subcategory : [];
    })();
    ...
    const removeProductImage = (imgIndex) => {
        setFormData((prev) => ({
            ...prev,
            product_images: prev.product_images.filter((_, index) => index !== imgIndex),
        }));
    };
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-800">{isEdit ? "Edit Product" : "Add Product"}</h1>
                        <p className="text-sm text-gray-500">Manage the product details, inventory, media, and status.</p>
                    </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-white p-6 sm:p-8 rounded-4xl border border-gray-100 shadow-sm space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <input type="text" name="name" value={formData.name} onChange={handleFormChange} placeholder="Enter product name" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" required />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Product Code (SKU)</label>
                                <input type="text" name="product_code" value={formData.product_code} onChange={handleFormChange} placeholder="SKU" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Barcode</label>
                                <input type="text" name="barcode" value={formData.barcode} onChange={handleFormChange} placeholder="Barcode" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Category</label>
                                <select name="category" value={formData.category} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                            ...
                            <div className="space-y-2">
                                ...
                                <select name="subcategory" value={formData.subcategory} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" disabled={derivedSubcategories.length === 0}>
                            ...
                            <div className="space-y-2">
                                ...
                                <input type="text" name="brand" value={formData.brand} onChange={handleFormChange} placeholder="Brand name" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2 md:col-span-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Description</label>
                                <textarea name="description" value={formData.description} onChange={handleFormChange} rows="4" placeholder="Describe the product" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800 resize-none" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 sm:p-8 rounded-4xl border border-gray-100 shadow-sm space-y-6">
                        <div className="flex items-center gap-3">
                            <span className="p-2.5 bg-amber-50 text-amber-600 rounded-xl"><FaRupeeSign size={20} /></span>
                            <h2 className="text-xl font-black text-slate-800">Pricing & Inventory</h2>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Weight / Volume</label>
                                <input type="text" name="weight_volume" value={formData.weight_volume} onChange={handleFormChange} placeholder="e.g. 500" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Unit</label>
                                <select name="unit" value={formData.unit} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">MRP</label>
                                <input type="number" name="mrp" value={formData.mrp} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Selling Price</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Maximum Stock</label>
                                <input type="number" name="maximum_stock" value={formData.maximum_stock} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Expiry Date</label>
                                <input type="date" name="expiry_date" value={formData.expiry_date} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Manufacturing Date</label>
                                <input type="date" name="manufacturing_date" value={formData.manufacturing_date} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Country of Origin</label>
                                <input type="text" name="country_of_origin" value={formData.country_of_origin} onChange={handleFormChange} placeholder="Country" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-white p-6 sm:p-8 rounded-4xl border border-gray-100 shadow-sm space-y-6">
                        <div className="flex items-center gap-3">
                            <span className="p-2.5 bg-purple-50 text-purple-600 rounded-xl"><FiImage size={20} /></span>
                            <h2 className="text-xl font-black text-slate-800">Media</h2>
                        </div>

                        <div className="space-y-4">
                            <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Product Images (Multiple)</label>
                            <label className="flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-2xl py-8 cursor-pointer hover:border-blue-500 transition-colors">
                                ...
                                <span className="mt-2 text-sm font-semibold text-slate-600">Upload product images</span>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                    {formData.product_images.map((img, index) => (
                                        <div key={index} className="relative group">
                                            <img src={img} alt={`Product ${index + 1}`} className="h-28 w-full object-cover rounded-2xl" />
                                            <button type="button" onClick={() => removeProductImage(index)} className="absolute inset-0 flex items-center justify-center rounded-2xl bg-red-600/70 text-white opacity-0 group-hover:opacity-100 transition-opacity">
                                                <FiTrash2 size={16} />
                                            </button>
                                        </div>
                                    ))}
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Thumbnail Image</label>
                            <label className="flex flex-col items-center justify-center border-2 border-dashed border-gray-200 rounded-2xl py-6 cursor-pointer hover:border-blue-500 transition-colors">
                                ...
                                <span className="mt-2 text-sm font-semibold text-slate-600">Upload thumbnail</span>
                                <input type="file" className="hidden" accept="image/*" onChange={handleThumbnailUpload} />
                            </label>
                            {formData.thumbnail_image && (
                                <img src={formData.thumbnail_image} alt="Thumbnail" className="h-32 w-full object-cover rounded-2xl" />
                            )}
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 sm:p-8 rounded-4xl border border-gray-100 shadow-sm space-y-6">
                        <div className="flex items-center gap-3">
                            <span className="p-2.5 bg-emerald-50 text-emerald-600 rounded-xl"><FiInfo size={20} /></span>
                            <h2 className="text-xl font-black text-slate-800">Status & Flags</h2>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Status</label>
                                <select name="status" value={formData.status} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                                    <option value="Active">Active</option>
                                    <option value="Inactive">Inactive</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Featured Product</label>
                                <select name="featured_product" value={formData.featured_product} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Best Seller</label>
                                <select name="best_seller" value={formData.best_seller} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Today's Deal</label>
                                <select name="todays_deal" value={formData.todays_deal} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                                ...
                                <input type="text" name="delivery_time" value={formData.delivery_time} onChange={handleFormChange} placeholder="e.g. 2-3 Days" className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Return Available</label>
                                <select name="return_available" value={formData.return_available} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                            <div className="space-y-2">
                                ...
                                <select name="rating" value={formData.rating} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Review Count</label>
                                <input type="number" name="review_count" value={formData.review_count} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Created At</label>
                                <input type="datetime-local" name="created_at" value={formData.created_at?.slice(0, 16) || ""} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest">Updated At</label>
                                <input type="datetime-local" name="updated_at" value={formData.updated_at?.slice(0, 16) || ""} onChange={handleFormChange} className="w-full px-4 py-3 bg-gray-50 rounded-2xl text-sm font-semibold text-slate-800" />
                            </div>
                        </div>
                    </div>
                </div>
